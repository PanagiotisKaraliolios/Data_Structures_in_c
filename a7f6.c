...
main(){
    ...
    do{
        ...
        if(Loc!=Pred)
            printf("[%d, %s, %d, %d]", HList.List[Loc].RecKey, HList.List[Loc].Name, HList.List[Loc].Amount, HList.List[Loc].Link);
        else
    ...
    do{
        ...
        SearchHashList(HList, AKey, &Loc, &Pred);
        if(Loc!=Pred){
            printf("[%d, %s, %d, %d]\n", HList.List[Loc].RecKey, HList.List[Loc].Name, HList.List[Loc].Amount, HList.List[Loc].Link);
            printf("Give amount: ");
            scanf("%d", &amount);
            if(amount<=HList.List[Loc].Amount)
                HList.List[Loc].Amount = HList.List[Loc].Amount - amount;
        }
        else
            printf("DEN YPARXEI EGGRAFH ME KLEIDI %d", AKey);
...
void PrintListOfSynonyms(HashListType HList, KeyType key){
    ...
    do{
        printf("%d:[%d,%s,%d]\n", Loc, HList.List[Loc].RecKey, HList.List[Loc].Name, HList.List[Loc].Amount);
...
void Print_HashList(HashListType HList)
{
    ...
    printf("========================================\n");
        ...
        for (i=0; i<HMax;i++)
        {
            ...
            {
                printf("[%d, %s, %d, %d]", HList.List[SubIndex].RecKey, HList.List[SubIndex].Name, HList.List[SubIndex].Amount, HList.List[SubIndex].Link);
                printf(" -> ");
...
void PrintPinakes(HashListType HList)
{
    ...
    for (i=0;i<HList.Size;i++)
        printf("%d) %d, %s, %d, %d\n", i, HList.List[i].RecKey, HList.List[i].Name, HList.List[i].Amount, HList.List[i].Link);
	printf("\n");
}
